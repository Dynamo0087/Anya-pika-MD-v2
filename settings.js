...
global.botname = "Senorita" 
global.botLanguage = "default" // 𝗗𝗲𝗳𝗮𝘂𝗹𝘁 || 𝗘𝗻𝗴𝗹𝗶𝘀𝗵 || 𝗛𝗶𝗻𝗱𝗶 || 𝗔𝗿𝗮𝗯𝗶𝗰 \\
global.author = "Amir Sohel"  
global.packname = "𝙌𝙐𝙀𝙀𝙉✯Senorita✯𝘽𝙊𝙏"  
global.myweb = "https://github.com/PikaBotz" // You can put any link 
global.waterMark = "×͜× Amiℝ ຮoheℓ⚠™ ✓" // Your own watermark 
global.headerText = "Senorita By Spidey" // text for header of menu         
global.DocumentTitle = "MASTER⚔️AMIR" 


global.ownername = "Spider Man"   // Owner name //        
global.ownernumber = ['916204450258'] 
global.socialm = "𝗜𝗻𝘀𝘁𝗮 : izb_champ" // 𝗜𝗻𝘀𝘁𝗮 : || 𝗚𝗶𝘁𝗵𝘂𝗯 : || 𝗙𝗮𝗰𝗲𝗯𝗼𝗼𝗸 : \\
global.ytname = "YT: NAR TV"   // Yt chanel name //
global.continent = "Asia" // your continent name 
global.region = "India" // your country name
global.state = "Jharkhand" // your state name
global.district = "Ranchi" // your district name
global.timezone = "Asia/Kolkata" // search on google if you don't know the timezone of your country //
global.instagramId = "izb_champ" // Your insta ID
global.email = "nothing@gmail.com" // put your email here
...
global.mess = {
    ...
    owner: 'This command is only for my 𝗼𝘄𝗻𝗲𝗿 Baby..',
